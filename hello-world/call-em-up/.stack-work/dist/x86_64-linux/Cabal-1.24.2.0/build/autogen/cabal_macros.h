...
/* package call-em-up-0.1.0.0 */
#define VERSION_call_em_up "0.1.0.0"
#define MIN_VERSION_call_em_up(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "call-em-up-0.1.0.0-A0uyAyS0hQoBFvxP0YBix9"

#define CURRENT_PACKAGE_KEY "call-em-up-0.1.0.0-A0uyAyS0hQoBFvxP0YBix9"
